...
def download_paper_pdf(repec_url: str, output_dir: Path) -> Optional[Path]:
...
if not papers_for_phase2:
    ...
    pdf_dir = Path(tempfile.mkdtemp(prefix="nep_papers_"))
    ...
    for i, p1_result in enumerate(papers_for_phase2, 1):
        ...
        # Download PDF
        pdf_path = download_paper_pdf(paper["link"], pdf_dir)
